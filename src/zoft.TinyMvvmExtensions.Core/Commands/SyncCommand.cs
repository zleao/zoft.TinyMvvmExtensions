...
// https://github.com/jamesmontemagno/mvvm-helpers/blob/master/MvvmHelpers/Commands/Command.cs
...
namespace zoft.TinyMvvmExtensions.Core.Commands
{
    ...
    public class Command<T> : SyncCommand
	{
		/// <summary>
	...
	public class SyncCommand : ICommand
	{
		...
		/// <param name="execute">Action to execute.</param>
		/// <param name="canExecute">Function to determine if can execute.</param>
		public SyncCommand(Action execute, Func<bool> canExecute) : this(o => execute())
		{
			if (execute == null)
				throw new ArgumentNullException(nameof(execute));
